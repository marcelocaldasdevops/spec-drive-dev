# Capability: Reserva de Estoque no Carrinho

## Purpose
Lida com o ciclo de vida da reserva temporária de inventário via Redis durante a etapa de carrinho, evitando concorrências indesejadas no checkout e garantindo fluidez para o usuário enquanto decide pela compra.
